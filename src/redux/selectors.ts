...
export const selectAdminApproveForm = (state: RootState) => state.modal.isAdminApprove;
export const selectChangeOrderForm = (state: RootState) => state.modal.isChangeOrderForm;
export const isRentalCarForm = (state: RootState) => state.modal.isRentalCarForm;
export const selectAdminOrderForm = (state: RootState) => state.modal.isAdminOrderForm;
...
export const selectUserOrdersHistory = (state:RootState) => state.orders.userOrdersHistory;
...
export const selectOrderForChanging = (state:RootState) => state.orders.orderForChanging;
export const selectNotificationOrders = (state:RootState) => state.orders.notificationOrders;
export const selectUserApprovedOrders = (state:RootState) => state.orders.notificationOrders?.approvedOrders;
export const selectUserEndedOrders = (state:RootState) => state.orders.notificationOrders?.endedOrders;
