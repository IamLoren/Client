  ...
  return (
    <section className="p-[10px] md:p-[20px] flex-1">
      ...
      <ul className="flex flex-wrap gap-[10px] mb-[10px] md:mb-[20px]">
        <li className="w-[145px] h-[50px] border border-color rounded-md">
          <p className="text-center secondary-text">Total orders</p>
          <span className=" block text-center">{allOrders.length}</span>
        </li>
        <li className="w-[145px] h-[50px] border border-color rounded-md">
          <p className="text-center secondary-text">Active orders</p>
          <span className=" block text-center">{activeOrders.length}</span>
        </li>
        <li className="w-[145px] h-[50px] border border-color rounded-md">
          <p className="text-center secondary-text">Cars under repair</p>
          <span className=" block text-center">{repairingCar.length}</span>
        </li>
        <li className="w-[145px] h-[50px] border border-color rounded-md">
          <p className="text-center secondary-text">Orders over time</p>
